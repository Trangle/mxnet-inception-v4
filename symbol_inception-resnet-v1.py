...
def InceptionResnetStem(data,
    ...
    stem_1_3x3 = Conv(data=stem_1_3x3, num_filter=num_2_3, kernel=(3, 3), stride=(2, 2), name=('%s_stem_1' % name), suffix='_conv_3')
...
if __name__ == '__main__':
    ...
    mx.viz.plot_network(net).render('inceptionbn-resnet-v1')